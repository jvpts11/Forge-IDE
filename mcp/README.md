...
| `build()`              | Run `polaron build` and show the output in the bottom panel |
...
Prereqs: a built `Forge.exe` (`polaron build` in the repo root), Python 3.10+, and `pip install mcp pillow`.
